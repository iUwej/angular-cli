import { NodeHost,InsertChange,ReplaceChange } from '../../lib/ast-tools';
...
export default Blueprint.extend({
  ...
  afterInstall: function (options: any) {
    ...
    const componentPath = `${importPath}.ts`;
    ...
    let fullPath= path.join(path.dirname(this.pathToModule),componentPath);
    console.log(chalk.bgWhite(`Injecting suilijic majic: ${fullPath}`));
    returns.push(new InsertChange(fullPath,0,"/***Testing this and more ****/\n").apply(NodeHost));
